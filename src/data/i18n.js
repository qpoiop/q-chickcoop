...
const STR = {
  en: {
    ...
    'hud.inventory': 'Inventory', 'hud.arsenal': 'Arsenal', 'hud.tech': 'Tech Tree',
    ...
    'prompt.core': 'Breach', 'prompt.crate': 'Salvage', 'prompt.extract': 'Extract',
    ...
    'evt.bossIn': '⚠ BOSS INBOUND', 'evt.bossDown': 'BOSS DOWN', 'evt.tutDone': 'TUTORIAL COMPLETE',
    ...
    'inv.openArsenal': 'Open Arsenal', 'inv.openTech': 'Tech Tree',
    'ars.eyebrow': 'Weapon Frames', 'ars.title': 'ARSENAL', 'ars.equipped': 'Equipped', 'ars.owned': 'Owned',
  ...
  ko: {
    ...
    'home.desc': '용암으로 둘러싸인 판자촌에 투입된 전투 치킨이다. 거리를 누비며 적 새떼를 막아내고, 빛나는 무기 드롭을 주워라. 모은 고철로 무기고에서 더 강한 총을 사고, 갈래형 기술 트리로 성장하라. 두 코어를 해킹해 게이트를 열고, 보스를 물리쳐 탈출하라.',
    ...
    'hud.inventory': '인벤토리', 'hud.arsenal': '무기고', 'hud.tech': '기술 트리',
    'hud.hintDesktop': 'WASD 이동 · 마우스 조준 · SPACE 대시 · E 상호작용',
    'hud.hintMobile': '왼쪽 스틱 — 이동 · 오른쪽 스틱 — 조준 & 사격 · DASH 회피',
    'prompt.core': '해킹', 'prompt.crate': '회수', 'prompt.extract': '탈출',
    ...
    'evt.bossIn': '⚠ 보스 접근', 'evt.bossDown': '보스 격파', 'evt.tutDone': '튜토리얼 완료',
    ...
    'inv.openArsenal': '무기고 열기', 'inv.openTech': '기술 트리',
    'ars.eyebrow': '무기 프레임', 'ars.title': '무기고', 'ars.equipped': '장착 중', 'ars.owned': '보유',
