...
const STR = {
  en: {
    ...
    'obj.portal': 'Enter the Portal', 'obj.boss': 'Defeat the Boss', 'obj.farm': 'Farm',
    'evt.breached': '{id} BREACHED', 'evt.salvage': '+SALVAGE', 'evt.gate': 'GATE UNLOCKED',
    'evt.portal': 'PORTAL OPEN', 'evt.extract': 'EXTRACTION READY', 'evt.farm': 'FARM AS MUCH AS YOU CAN — BOSS IN 3:00',
  ...
  ko: {
    ...
    'obj.portal': '포탈로 진입', 'obj.boss': '보스를 처치하라', 'obj.farm': '파밍',
    'evt.breached': '{id} 해킹 완료', 'evt.salvage': '+회수', 'evt.gate': '게이트 개방',
    'evt.portal': '포탈 개방', 'evt.extract': '탈출구 개방', 'evt.farm': '최대한 많이 파밍하세요 — 3분 뒤 보스',
