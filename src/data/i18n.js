...
const STR = {
  en: {
    ...
    'obj.portal': 'Enter the Portal', 'obj.boss': 'Defeat the Boss', 'obj.farm': 'Farm', 'obj.portalBoss': 'Enter the Portal — Defeat the Boss',
    'evt.breached': '{id} BREACHED', 'evt.salvage': '+SALVAGE', 'evt.gate': 'GATE UNLOCKED',
    'evt.portal': 'PORTAL OPEN', 'evt.extract': 'EXTRACTION READY', 'evt.farm': 'FARM AS MUCH AS YOU CAN — OR TAKE THE PORTAL', 'evt.farmEnd': 'TIME UP — ENTER THE PORTAL TO FIGHT THE BOSS',
  ...
  ko: {
    ...
    'obj.portal': '포탈로 진입', 'obj.boss': '보스를 처치하라', 'obj.farm': '파밍', 'obj.portalBoss': '포탈로 진입 — 보스 처치',
    'evt.breached': '{id} 해킹 완료', 'evt.salvage': '+회수', 'evt.gate': '게이트 개방',
    'evt.portal': '포탈 개방', 'evt.extract': '탈출구 개방', 'evt.farm': '최대한 많이 파밍하세요 — 준비되면 포탈로', 'evt.farmEnd': '시간 종료 — 포탈로 들어가 보스를 처치하세요',
